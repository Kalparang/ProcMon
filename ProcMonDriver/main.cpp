...
--*/
{
    ...
    valueBuffer = (PKEY_VALUE_PARTIAL_INFORMATION)ExAllocatePoolWithTag(NonPagedPool,
        valueLength,
        SCANNER_REG_TAG);
    ...
    ScannedExtensions = (PUNICODE_STRING)ExAllocatePoolWithTag(PagedPool,
...
--*/
{
    ...
    ScannerData.UserProcess = (PEPROCESS)PsGetCurrentProcess();
    ...
    __try {
        ...
        if (Data->Iopb->Parameters.Write.Length != 0) {
            ...
            if (Data->Iopb->Parameters.Write.MdlAddress != NULL) {
                ...
                buffer = (PUCHAR)MmGetSystemAddressForMdlSafe(Data->Iopb->Parameters.Write.MdlAddress,
            ...
            notification = (PSCANNER_NOTIFICATION)ExAllocatePoolWithTag(NonPagedPool,
